...
describe User do 
  ...
  it "should accept vaild email addresses" do
    addresses = %w[user@foo.com THE_USER@foo.bar.com firs.last@foo.jp dom_campbell@hotmail.com]
  ...
  it "should reject duplicate emails addresses" do
    User.create!(@attr)
  ...
  describe "password encryption" do
    ...
    it "should have an encrypted passowrd attribute" do
    ...
    describe "authenticate method" do
      ...
      it "should return nil for an email address with no user" do
        nonexistant_user = User.authenticate("nonexistant@user.com", @attr[:password])
